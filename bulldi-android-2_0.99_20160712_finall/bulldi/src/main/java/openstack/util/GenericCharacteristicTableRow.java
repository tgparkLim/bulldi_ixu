...
/*
 * GenericCharacteristicTableRow.java
 */
...
public class GenericCharacteristicTableRow extends TableRow implements View.OnClickListener, Animation.AnimationListener, SeekBar.OnSeekBarChangeListener, CompoundButton.OnCheckedChangeListener {
	...
	public final static String ACTION_ONOFF_UPDATE = "openstack.util.ACTION_ONOFF_UPDATE";
	public final static String ACTION_CALIBRATE = "openstack.util.ACTION_CALIBRATE";
	...
	public final static String EXTRA_ONOFF = "openstack.util.EXTRA_ONOFF";
