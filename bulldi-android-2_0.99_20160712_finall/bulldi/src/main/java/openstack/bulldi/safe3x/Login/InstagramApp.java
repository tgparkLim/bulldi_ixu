...
/*
 * InstagramApp.java: instagram api
 */
...
public class InstagramApp {
    ...
    private List<String> user_information = new ArrayList<String>();
        ...
        new Thread() {
            ...
            public void run() {
                ...
                try {
                    ...
                    String response = Utils.streamToString(urlConnection
                            .getInputStream());
                    Log.d(TAG, "Opening self " + response);
                    ...
                    user_information.add(data_obj.getString(TAG_ID));
                    ...
                    user_information.add(data_obj.getString(TAG_USERNAME));
    ...
    public List<String> get_information() {
