...
public class BluetoothLeService extends Service {
	...
	public final static String ACTION_GATT_CONNECTED = "openstack.bulldi.common.ACTION_GATT_CONNECTED";
	public final static String ACTION_GATT_DISCONNECTED = "openstack.bulldi.common.ACTION_GATT_DISCONNECTED";
	public final static String ACTION_GATT_SERVICES_DISCOVERED = "openstack.bulldi.common.ACTION_GATT_SERVICES_DISCOVERED";
	public final static String ACTION_DATA_READ = "openstack.bulldi.common.ACTION_DATA_READ";
	public final static String ACTION_DATA_NOTIFY = "openstack.bulldi.common.ACTION_DATA_NOTIFY";
	public final static String ACTION_DATA_WRITE = "openstack.bulldi.common.ACTION_DATA_WRITE";
	public final static String EXTRA_DATA = "openstack.bulldi.common.EXTRA_DATA";
	public final static String EXTRA_UUID = "openstack.bulldi.common.EXTRA_UUID";
	public final static String EXTRA_STATUS = "openstack.bulldi.common.EXTRA_STATUS";
	public final static String EXTRA_ADDRESS = "openstack.bulldi.common.EXTRA_ADDRESS";
	...
	private void broadcastUpdate(final String action, final String address,
        ...
        //Log.i("Check broadcastUpdate", "value of action: " + status);
	}
	...
	public boolean onUnbind(Intent intent) {
		...
		// such that resources are cleaned up properly. In this particular detection,
		// close() is
