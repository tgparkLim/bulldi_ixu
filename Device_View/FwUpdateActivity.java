...
/*
 * FwUpdateActivity.java: control firmware update
 */
...
import openstack.util.Conversion;


public class FwUpdateActivity extends Activity {
    public final static String EXTRA_MESSAGE = "openstack.bulldi.safe3x.Device_View.MESSAGE";
    // Log
